...
-   **[2. Abc files, tunes and fragments](https://abcnotation.com/wiki/abc:standard:v2.1#abc_files_tunes_and_fragments "abc:standard:v2.1 ↵")**
    ...
    -   **[2.1 Abc file identification](https://abcnotation.com/wiki/abc:standard:v2.1#abc_file_identification "abc:standard:v2.1 ↵")**
...
-   **[3. Information fields](https://abcnotation.com/wiki/abc:standard:v2.1#information_fields "abc:standard:v2.1 ↵")**
    ...
    -   **[3.1 Description of information fields](https://abcnotation.com/wiki/abc:standard:v2.1#description_of_information_fields "abc:standard:v2.1 ↵")**
        ...
        -   **[3.1.6 M: - meter](https://abcnotation.com/wiki/abc:standard:v2.1#mmeter "abc:standard:v2.1 ↵")**
...
-   **[4. The tune body](https://abcnotation.com/wiki/abc:standard:v2.1#the_tune_body "abc:standard:v2.1 ↵")**
    ...
    -   **[4.6 Clefs and transposition](https://abcnotation.com/wiki/abc:standard:v2.1#clefs_and_transposition "abc:standard:v2.1 ↵")**
...
-   **[6. Typesetting and playback](https://abcnotation.com/wiki/abc:standard:v2.1#typesetting_and_playback "abc:standard:v2.1 ↵")**
    ...
    -   **[6.1 Typesetting](https://abcnotation.com/wiki/abc:standard:v2.1#typesetting "abc:standard:v2.1 ↵")**
        ...
        -   **[6.1.2 Typesetting extra space](https://abcnotation.com/wiki/abc:standard:v2.1#typesetting_extra_space "abc:standard:v2.1 ↵")**
...
-   **[10. Outdated syntax](https://abcnotation.com/wiki/abc:standard:v2.1#outdated_syntax "abc:standard:v2.1 ↵")**
    ...
    -   **[10.4 Outdated directives](https://abcnotation.com/wiki/abc:standard:v2.1#outdated_directives "abc:standard:v2.1 ↵")**
...
-   **[11. Stylesheet directives and pseudo-comments](https://abcnotation.com/wiki/abc:standard:v2.1#stylesheet_directives_and_pseudo-comments "abc:standard:v2.1 ↵")**
    ...
    -   **[11.4 Formatting directives](https://abcnotation.com/wiki/abc:standard:v2.1#formatting_directives "abc:standard:v2.1 ↵")**
        ...
        -   **[11.4.6 Information directives](https://abcnotation.com/wiki/abc:standard:v2.1#information_directives "abc:standard:v2.1 ↵")**
...
-   **[inline field](https://abcnotation.com/wiki/abc:standard:v2.1#inline_field_definition "abc:standard:v2.1 ↵")**
...
**_Comment:_ Some web-servers only allow a limited selection of file types; in this case a ".txt" extension is the best alternative.**
...
**The terms [free text](https://abcnotation.com/wiki/abc:standard:v2.1#free_text_definition "abc:standard:v2.1 ↵") and [typeset text](https://abcnotation.com/wiki/abc:standard:v2.1#typeset_text_definition "abc:standard:v2.1 ↵") refer to any text not directly included within the [information fields](https://abcnotation.com/wiki/abc:standard:v2.1#information_field_definition "abc:standard:v2.1 ↵") in a [tune header](https://abcnotation.com/wiki/abc:standard:v2.1#tune_header_definition "abc:standard:v2.1 ↵"). Typically such text is used for annotating [abc tunebooks](https://abcnotation.com/wiki/abc:standard:v2.1#abc_tunebook_definition "abc:standard:v2.1 ↵"); [free text](https://abcnotation.com/wiki/abc:standard:v2.1#free_text_definition "abc:standard:v2.1 ↵") is for annotating the [abc file](https://abcnotation.com/wiki/abc:standard:v2.1#abc_file_definition "abc:standard:v2.1 ↵") but is not included in the typeset score, whereas [typeset text](https://abcnotation.com/wiki/abc:standard:v2.1#typeset_text_definition "abc:standard:v2.1 ↵") is intended for printing out.**
...
**The following rules are applied to [embedded](https://abcnotation.com/wiki/abc:standard:v2.1#embedded_definition "abc:standard:v2.1 ↵") elements:**
...
**An [information field](https://abcnotation.com/wiki/abc:standard:v2.1#information_field_definition "abc:standard:v2.1 ↵") may also be inlined in a [tune body](https://abcnotation.com/wiki/abc:standard:v2.1#tune_body_definition "abc:standard:v2.1 ↵") when enclosed by `[` and `]`- see [use of fields within the tune body](https://abcnotation.com/wiki/abc:standard:v2.1#use_of_fields_within_the_tune_body "abc:standard:v2.1 ↵").**
...
**See [typesetting information fields](https://abcnotation.com/wiki/abc:standard:v2.1#typesetting_information_fields "abc:standard:v2.1 ↵") for details of how the composer is included in the printed score.**
...
**However, it has also taken over the role of the `%%abc-copyright` and `%%abc-edited-by` since they have been [deprecated](https://abcnotation.com/wiki/abc:standard:v2.1#outdated_syntax "abc:standard:v2.1 ↵") (see [outdated directives](https://abcnotation.com/wiki/abc:standard:v2.1#outdated_directives "abc:standard:v2.1 ↵")).**
...
**See [typesetting information fields](https://abcnotation.com/wiki/abc:standard:v2.1#typesetting_information_fields "abc:standard:v2.1 ↵") for details of how the transcription information may be included in the printed score.**
...
**See [typesetting information fields](https://abcnotation.com/wiki/abc:standard:v2.1#typesetting_information_fields "abc:standard:v2.1 ↵") for details of how notes may be included in the printed score.**
...
**The original usage of `H:` (where subsequent lines need no field indicator) is now [deprecated](https://abcnotation.com/wiki/abc:standard:v2.1#outdated_syntax "abc:standard:v2.1 ↵") (see [outdated information field syntax](https://abcnotation.com/wiki/abc:standard:v2.1#outdated_information_field_syntax "abc:standard:v2.1 ↵")).** 

**See [typesetting information fields](https://abcnotation.com/wiki/abc:standard:v2.1#typesetting_information_fields "abc:standard:v2.1 ↵") for details of how the history may be included in the printed score.**
...
**By default, the [abc tune](https://abcnotation.com/wiki/abc:standard:v2.1#abc_tune_definition "abc:standard:v2.1 ↵") will be typeset with a treble clef. You can add special clef specifiers to the `K:` field, with or without a key signature, to change the clef and various other staff properties, such as transposition. `K: clef=bass`, for example, would indicate the bass clef. See [clefs and transposition](https://abcnotation.com/wiki/abc:standard:v2.1#clefs_and_transposition "abc:standard:v2.1 ↵") for full details.**

**Note that the first occurrence of the `K:` field, which must appear in every tune, finishes the [tune header](https://abcnotation.com/wiki/abc:standard:v2.1#tune_header_definition "abc:standard:v2.1 ↵"). All following lines are considered to be part of the [tune body](https://abcnotation.com/wiki/abc:standard:v2.1#tune_body_definition "abc:standard:v2.1 ↵").**

#### **3.1.15 R: - rhythm**

**Contains an indication of the type of tune (e.g. hornpipe, double jig, single jig, 48-bar polka, etc). This gives the musician some indication of how a tune should be interpreted as well as being useful for database applications (see [background information](https://abcnotation.com/wiki/abc:standard:v2.1#bdfsbackground_information "abc:standard:v2.1 ↵")). It has also been used experimentally by playback software (in particular, [abcmus](https://abcnotation.com/software#abcmus "https://abcnotation.com/software#abcmus")) to provide more realistic playback by altering the stress on particular notes within a bar.**

**See [typesetting information fields](https://abcnotation.com/wiki/abc:standard:v2.1#typesetting_information_fields "abc:standard:v2.1 ↵") for details of how the rhythm may be included in the printed score.**

#### **3.1.16 B:, D:, F:, S: - background information**

**The [information fields](https://abcnotation.com/wiki/abc:standard:v2.1#information_field_definition "abc:standard:v2.1 ↵") `B:book` (i.e. printed tune book), `D:discography` (i.e. a CD or LP where the tune can be heard), `F:file url` (i.e. where the either the [abc tune](https://abcnotation.com/wiki/abc:standard:v2.1#abc_tune_definition "abc:standard:v2.1 ↵") or the [abc file](https://abcnotation.com/wiki/abc:standard:v2.1#abc_file_definition "abc:standard:v2.1 ↵") can be found on the web) and `S:source` (i.e. the circumstances under which a tune was collected or learned), as well as the fields `[H:history](https://abcnotation.com/wiki/abc:standard:v2.1#hhistory "abc:standard:v2.1 ↵")`, `[N:notes](https://abcnotation.com/wiki/abc:standard:v2.1#nnotes "abc:standard:v2.1 ↵")`, `[O:origin](https://abcnotation.com/wiki/abc:standard:v2.1#oorigin "abc:standard:v2.1 ↵")` and `[R:rhythm](https://abcnotation.com/wiki/abc:standard:v2.1#rrhythm "abc:standard:v2.1 ↵")` mentioned above, are used for providing structured background information about a tune. These are particularly aimed at large tune collections (common in abc since its inception) and, if used in a systematic way, mean that abc database software can sort, search and filter on specific fields (for example, to sort by rhythm or filter out all the tunes on a particular CD).**

**The abc standard does not prescribe how these fields should be used, but it is typical to employ several fields of the same type each containing one piece of information, rather than one field containing several pieces of information (see [English.abc](https://abcnotation.com/wiki/abc:standard:v2.1#englishabc "abc:standard:v2.1 ↵") for some examples).**

**See [typesetting information fields](https://abcnotation.com/wiki/abc:standard:v2.1#typesetting_information_fields "abc:standard:v2.1 ↵") for details of how background information may be included in the printed score.**
...
**The `I:` field can be used interchangeably with [stylesheet directives](https://abcnotation.com/wiki/abc:standard:v2.1#stylesheet_directive_definition "abc:standard:v2.1 ↵") so that any `I:directive` may instead be written `%%directive`, and vice-versa. However, to use the [inline](https://abcnotation.com/wiki/abc:standard:v2.1#use_of_fields_within_the_tune_body "abc:standard:v2.1 ↵") version, the `I:` version must be used.**

**Despite this interchangeability, certain directives have been adopted as part of the standard (indicated by `I:` in this document) and must be implemented by software confirming to this version of the standard; conversely, the [stylesheet directives](https://abcnotation.com/wiki/abc:standard:v2.1#stylesheet_directive_definition "abc:standard:v2.1 ↵") (indicated by `%%` in this document) are optional.**

**_Comment:_ Since [stylesheet directives](https://abcnotation.com/wiki/abc:standard:v2.1#stylesheet_directive_definition "abc:standard:v2.1 ↵") are optional, and not necessarily portable from one program to another, this means that `I:` fields containing [stylesheet directives](https://abcnotation.com/wiki/abc:standard:v2.1#stylesheet_directive_definition "abc:standard:v2.1 ↵") should be treated liberally by abc software and, in particular, that `I:` fields which are not recognised should be ignored.**
...
[charset field](https://abcnotation.com/wiki/abc:standard:v2.1#charset_field "abc:standard:v2.1 ↵")

`I:abc-version`

[version field](https://abcnotation.com/wiki/abc:standard:v2.1#version_field "abc:standard:v2.1 ↵")

`I:abc-include`

[include field](https://abcnotation.com/wiki/abc:standard:v2.1#include_field "abc:standard:v2.1 ↵")

`I:abc-creator`

[creator field](https://abcnotation.com/wiki/abc:standard:v2.1#creator_field "abc:standard:v2.1 ↵")

`I:linebreak`

[typesetting line breaks](https://abcnotation.com/wiki/abc:standard:v2.1#typesetting_line-breaks "abc:standard:v2.1 ↵")

`I:decoration`

[decoration dialects](https://abcnotation.com/wiki/abc:standard:v2.1#decoration_dialects "abc:standard:v2.1 ↵")

**Typically, instruction fields are for use in the [file header](https://abcnotation.com/wiki/abc:standard:v2.1#file_header_definition "abc:standard:v2.1 ↵"), to set defaults for the file, or (in most cases) in the [tune header](https://abcnotation.com/wiki/abc:standard:v2.1#tune_header_definition "abc:standard:v2.1 ↵"), but not in the [tune body](https://abcnotation.com/wiki/abc:standard:v2.1#tune_body_definition "abc:standard:v2.1 ↵"). The occurrence of an instruction field in a [tune header](https://abcnotation.com/wiki/abc:standard:v2.1#tune_header_definition "abc:standard:v2.1 ↵") overrides that in the [file header](https://abcnotation.com/wiki/abc:standard:v2.1#file_header_definition "abc:standard:v2.1 ↵").**

**_Comment:_ Remember that abc software which extracts separate tunes from a file must insert the fields of the original [file header](https://abcnotation.com/wiki/abc:standard:v2.1#file_header_definition "abc:standard:v2.1 ↵") into the header of the extracted tune: this is also true for the fields defined in this section.**

##### **Charset field**

**The `I:abc-charset <value>` field indicates the character set in which [text strings](https://abcnotation.com/wiki/abc:standard:v2.1#text_string_definition "abc:standard:v2.1 ↵") are coded. Since this affects how the file is read, it should appear as early as possible in the [file header](https://abcnotation.com/wiki/abc:standard:v2.1#file_header_definition "abc:standard:v2.1 ↵"). It may not be changed further on in the file.**
...
**Software that exports [abc tunes](https://abcnotation.com/wiki/abc:standard:v2.1#abc_tune_definition "abc:standard:v2.1 ↵") conforming to this standard should include a charset field if an encoding other than `utf-8` is used. All conforming abc software must be able to handle [text strings](https://abcnotation.com/wiki/abc:standard:v2.1#text_string_definition "abc:standard:v2.1 ↵") coded in `utf-8` and `us-ascii`. Support for the other charsets is optional.**
...
**Every [abc file](https://abcnotation.com/wiki/abc:standard:v2.1#abc_file_definition "abc:standard:v2.1 ↵") conforming to this standard should start with the line**

**%abc-2.1**

**(see [abc file identification](https://abcnotation.com/wiki/abc:standard:v2.1#abc_file_identification "abc:standard:v2.1 ↵")).**

**However to indicate tunes conforming to a different standard it is possible to use the `I:abc-version <value>` field, either in the [tune header](https://abcnotation.com/wiki/abc:standard:v2.1#tune_header_definition "abc:standard:v2.1 ↵") (for individual tunes) or in the [file header](https://abcnotation.com/wiki/abc:standard:v2.1#file_header_definition "abc:standard:v2.1 ↵").**
...
**The `I:abc-include <filename.abh>` imports the definitions found in a separate abc header file (.abh), and inserts them into the [file header](https://abcnotation.com/wiki/abc:standard:v2.1#file_header_definition "abc:standard:v2.1 ↵") or [tune header](https://abcnotation.com/wiki/abc:standard:v2.1#tune_header_definition "abc:standard:v2.1 ↵").**

**_Example:_** 

**I:abc-include mydefs.abh**

**The included file may contain [information fields](https://abcnotation.com/wiki/abc:standard:v2.1#information_field_definition "abc:standard:v2.1 ↵"), [stylesheet directives](https://abcnotation.com/wiki/abc:standard:v2.1#stylesheet_directive_definition "abc:standard:v2.1 ↵") and [comments](https://abcnotation.com/wiki/abc:standard:v2.1#comments_and_remarks "abc:standard:v2.1 ↵"), but no other abc constructs.**

**If the header file cannot be found, the `I:abc-include` instruction should be ignored with a non-fatal error message.**

**_Comment:_ If you use this construct and distribute your [abc files](https://abcnotation.com/wiki/abc:standard:v2.1#abc_file_definition "abc:standard:v2.1 ↵"), make sure that you distribute the .abh files with them.**

##### **Creator field**

**The `I:abc-creator <value>` field contains the name and version number of the program that created the [abc file](https://abcnotation.com/wiki/abc:standard:v2.1#abc_file_definition "abc:standard:v2.1 ↵").**

**_Example:_** 

**I:abc-creator xml2abc-2.7**

**Software that exports [abc tunes](https://abcnotation.com/wiki/abc:standard:v2.1#abc_tune_definition "abc:standard:v2.1 ↵") conforming to this standard must include a creator field.**

#### **3.1.18 Other fields**

-   **For `m:` see [macros](https://abcnotation.com/wiki/abc:standard:v2.1#macros "abc:standard:v2.1 ↵").**
    
-   **For `r:` see [comments and remarks](https://abcnotation.com/wiki/abc:standard:v2.1#comments_and_remarks "abc:standard:v2.1 ↵").**
    
-   **For `s:` see [symbol lines](https://abcnotation.com/wiki/abc:standard:v2.1#symbol_lines "abc:standard:v2.1 ↵").**
    
-   **For `U:` see [redefinable symbols](https://abcnotation.com/wiki/abc:standard:v2.1#redefinable_symbols "abc:standard:v2.1 ↵").** 
    
-   **For `V:` see [multiple voices](https://abcnotation.com/wiki/abc:standard:v2.1#multiple_voices "abc:standard:v2.1 ↵").**
    
-   **For `W:` and `w:` see [lyrics](https://abcnotation.com/wiki/abc:standard:v2.1#lyrics "abc:standard:v2.1 ↵").**
    

### **3.2 Use of fields within the tune body**

**It is often desired to change the key (`K`), meter (`M`), or unit note length (`L`) mid-tune. These, and most other [information fields](https://abcnotation.com/wiki/abc:standard:v2.1#information_field_definition "abc:standard:v2.1 ↵") which can be legally used within the [tune body](https://abcnotation.com/wiki/abc:standard:v2.1#tune_body_definition "abc:standard:v2.1 ↵"), can be specified as an **inline field** by placing them within square brackets in a line of music**
...
**The first bracket, field identifier and colon must be written without intervening spaces. Only one field may be placed within a pair of brackets; however, multiple bracketed fields may be placed next to each other. Where appropriate, [inline fields](https://abcnotation.com/wiki/abc:standard:v2.1#inline_field_definition "abc:standard:v2.1 ↵") (especially clef changes) can be used in the middle of a beam without breaking it.**

**See [information fields](https://abcnotation.com/wiki/abc:standard:v2.1#information_fields "abc:standard:v2.1 ↵") for a table showing the fields that may appear within the body and those that may be used inline.**

### **3.3 Field continuation**

**A field that is too long for one line may be continued by prefixing `+:` at the start of the following line. For string-type [information fields](https://abcnotation.com/wiki/abc:standard:v2.1#information_field_definition "abc:standard:v2.1 ↵") (see the [information fields](https://abcnotation.com/wiki/abc:standard:v2.1#information_fields "abc:standard:v2.1 ↵")table for a list of string-type fields), the continuation is considered to add a space between the two half lines.**
...
**_Comment:_ This is most useful for continuing long `w:(aligned lyrics)` and `H:(history)` fields. However, it can also be useful for preventing automatic wrapping by email software (see [continuation of input lines](https://abcnotation.com/wiki/abc:standard:v2.1#continuation_of_input_lines "abc:standard:v2.1 ↵")).**

**_Recommendation for GUI developers:_ Sometimes users may wish to paste paragraphs of text into an [abc file](https://abcnotation.com/wiki/abc:standard:v2.1#abc_file_definition "abc:standard:v2.1 ↵"), particularly in the `H:(history)` field. GUIdevelopers are recommended to provide tools for reformatting such paragraphs, for example by splitting them into several lines each prefixed by `+:`.**

**There is no limit to the number of times a field may be continued and [comments](https://abcnotation.com/wiki/abc:standard:v2.1#comments_and_remarks "abc:standard:v2.1 ↵")and [stylesheet directives](https://abcnotation.com/wiki/abc:standard:v2.1#stylesheet_directive_definition "abc:standard:v2.1 ↵") may be interspersed between the continuations.**

**_Example:_ The following is a legal continuation of the `w:` field, although the usage not recommended (the change of font could also be achieved by font specifiers - see [font directives](https://abcnotation.com/wiki/abc:standard:v2.1#font_directives "abc:standard:v2.1 ↵")).**
...
**Alternatively, it is possible to raise or lower a section of [music code](https://abcnotation.com/wiki/abc:standard:v2.1#music_code_definition "abc:standard:v2.1 ↵") using the `octave` parameter of the `K:` or `V:` fields.**
...
**The [unit note length](https://abcnotation.com/wiki/abc:standard:v2.1#lunit_note_length "abc:standard:v2.1 ↵") for the transcription is set in the `L:` field or, if the `L:` field does not exist, inferred from the `M:` field. For example, `L:1/8` sets an eighth note as the unit note length.**
...
**To get shorter notes, either divide them - e.g. if `A` is an eighth note, `A/2` is a sixteenth note, `A3/2` is a dotted eighth note, `A/4` is a thirty-second note - or change the [unit note length](https://abcnotation.com/wiki/abc:standard:v2.1#lunit_note_length "abc:standard:v2.1 ↵") with the `L:` field. Alternatively, if the music has a broken rhythm, e.g. dotted eighth note/sixteenth note pairs, use [broken rhythm](https://abcnotation.com/wiki/abc:standard:v2.1#broken_rhythm "abc:standard:v2.1 ↵")markers.**
...
**_Note for developers:_ All compliant software should be able to handle note lengths down to a 128th note; shorter lengths are optional.**
...
**Clef and transposition information may be provided in the `K:` [key](https://abcnotation.com/wiki/abc:standard:v2.1#kkey "abc:standard:v2.1 ↵") and `V:` [voice](https://abcnotation.com/wiki/abc:standard:v2.1#multiple_voices "abc:standard:v2.1 ↵")fields. The general syntax is:**
...
-   **`[octave=<number>]` to raise (positive number) or lower (negative number) the [music code](https://abcnotation.com/wiki/abc:standard:v2.1#music_code_definition "abc:standard:v2.1 ↵") in the current voice by one or more octaves. This usage can help to avoid the need to write lots of apostrophes or commas to raise or lower notes.**
...
**An invisible bar line may be notated by putting the bar line in brackets, e.g. `[|]`- this may be useful for notating [voice overlay](https://abcnotation.com/wiki/abc:standard:v2.1#voice_overlay "abc:standard:v2.1 ↵") in meter-free music.**
...
**Note that in many [abc files](https://abcnotation.com/wiki/abc:standard:v2.1#abc_file_definition "abc:standard:v2.1 ↵") the `|:` may not be present.**

### **4.10 Variant endings**

**In combination with `P:` [part notation](https://abcnotation.com/wiki/abc:standard:v2.1#pparts "abc:standard:v2.1 ↵"), it is possible to notate more than two variant endings for a section that is to be repeated a number of times.**
...
**You can tie two notes of the same pitch together, within or between bars, with a `-` symbol, e.g. `abc-|cba` or `c4-c4`. The tie symbol must always be adjacent to the first note of the pair, but does not need to be adjacent to the second, e.g. `c4 -c4` and `abc|-cba` are not legal - see [order of abc constructs](https://abcnotation.com/wiki/abc:standard:v2.1#order_of_abc_constructs "abc:standard:v2.1 ↵").**
...
**Grace notes can be written by enclosing them in curly braces, `{}`. For example, a taorluath on the Highland pipes would be written `{GdGe}`. The tune 'Athol Brose' (in the file [Strspys.abc](https://abcnotation.com/wiki/abc:standard:v2.1#strspysabc "abc:standard:v2.1 ↵")) has an example of complex Highland pipe gracing in all its glory. Although nominally grace notes have no melodic time value, expressions such as `{a3/2b/}` or `{a>b}` can be useful and are legal although some software may ignore them. The unit duration to use for gracenotes is not specified by the [abc file](https://abcnotation.com/wiki/abc:standard:v2.1#abc_file_definition "abc:standard:v2.1 ↵"), but by the software, and might be a specific amount of time (for playback purposes) or a note length (e.g. 1/32 for Highland pipe music, which would allow `{ge4d}` to code a piobaireachd 'cadence').**
...
9 notes in the time of _n_

**If the time signature is compound (6/8, 9/8, 12/8) then _n_ is three, otherwise _n_is two.**
...
**Decorations should be placed before the note which they decorate - see [order of abc constructs](https://abcnotation.com/wiki/abc:standard:v2.1#order_of_abc_constructs "abc:standard:v2.1 ↵")**
...
**Most of the characters above (`~HLMOPSTuv`) are just short-cuts for commonly used decorations and can even be redefined (see [redefinable symbols](https://abcnotation.com/wiki/abc:standard:v2.1#redefinable_symbols "abc:standard:v2.1 ↵")).**

**More generally, symbols can be entered using the syntax `!symbol!`, e.g. `!trill!A4` for a trill symbol. (Note that the abc standard version 2.0 used instead the syntax `+symbol+` - this dialect of abc is still available, but is now [deprecated](https://abcnotation.com/wiki/abc:standard:v2.1#outdated_syntax "abc:standard:v2.1 ↵") - see [decoration dialects](https://abcnotation.com/wiki/abc:standard:v2.1#decoration_dialects "abc:standard:v2.1 ↵").)**
...
**Note that the decorations may be applied to notes, rests, note groups, and bar lines. If a decoration is to be typeset between notes, it may be attached to the `y`spacer - see [typesetting extra space](https://abcnotation.com/wiki/abc:standard:v2.1#typesetting_extra_space "abc:standard:v2.1 ↵").**
...
**Adding many symbols to a line of music can make a tune difficult to read. In such cases, a symbol line (a line that contains only `!…!` [decorations](https://abcnotation.com/wiki/abc:standard:v2.1#decorations "abc:standard:v2.1 ↵"), `"…"` [chord symbols](https://abcnotation.com/wiki/abc:standard:v2.1#chord_symbols "abc:standard:v2.1 ↵") or [annotations](https://abcnotation.com/wiki/abc:standard:v2.1#annotations "abc:standard:v2.1 ↵")) can be used, analogous to a line of [lyrics](https://abcnotation.com/wiki/abc:standard:v2.1#lyrics "abc:standard:v2.1 ↵").** 

**A symbol line starts with `s:`, followed by a line of symbols. Matching of notes and symbols follow the [alignment rules](https://abcnotation.com/wiki/abc:standard:v2.1#alignment "abc:standard:v2.1 ↵") defined for lyrics (meaning that symbols in an `s:` line cannot be aligned on [grace notes](https://abcnotation.com/wiki/abc:standard:v2.1#grace_notes "abc:standard:v2.1 ↵"), [rests](https://abcnotation.com/wiki/abc:standard:v2.1#rests "abc:standard:v2.1 ↵") or [spacers](https://abcnotation.com/wiki/abc:standard:v2.1#typesetting_extra_space "abc:standard:v2.1 ↵")).**
...
**As a short cut to writing symbols which avoids the `!symbol!` syntax (see [decorations](https://abcnotation.com/wiki/abc:standard:v2.1#decorations "abc:standard:v2.1 ↵")), the letters `H-W` and `h-w` and the symbol `~` can be assigned with the `U:` field. For example, to assign the letter `T` to represent the trill, you can write:**

**U: T = !trill!**

**You can also use `"^text"`, etc (see [annotations](https://abcnotation.com/wiki/abc:standard:v2.1#annotations "abc:standard:v2.1 ↵") below) in definitions**

**_Example:_ To print a plus sign over notes, define `p` as follows and use it before the required notes:**

**U: p = "^+"**

**Symbol definitions can be written in the [file header](https://abcnotation.com/wiki/abc:standard:v2.1#file_header_definition "abc:standard:v2.1 ↵"), in which case they apply to all the tunes in that file, or in a [tune header](https://abcnotation.com/wiki/abc:standard:v2.1#tune_header_definition "abc:standard:v2.1 ↵"), when they apply only to that tune, and override any previous definitions. Programs may also make use of a set of global default definitions, which apply everywhere unless overridden by local definitions. You can assign the same symbol to two or more letters e.g.**
...
**Please see [macros](https://abcnotation.com/wiki/abc:standard:v2.1#macros "abc:standard:v2.1 ↵") for an advanced macro mechanism.**
...
**but there should be no spaces within the notation for a chord. See the tune 'Kitchen Girl' in the sample file [Reels.abc](https://abcnotation.com/wiki/abc:standard:v2.1#reelsabc "abc:standard:v2.1 ↵") for a simple example.**
...
**More complicated chords can be transcribed with the `&` operator (see [voice overlay](https://abcnotation.com/wiki/abc:standard:v2.1#voice_overlay "abc:standard:v2.1 ↵")).**
...
**The chord has the format _<note><accidental><type></bass>_, where _<note>_can be `A-G`, the optional _<accidental>_ can be `b`, `#`, the optional _<type>_ is one or more of**
...
**Each [tie symbol](https://abcnotation.com/wiki/abc:standard:v2.1#ties_and_slurs "abc:standard:v2.1 ↵"), `-`, should come immediately after a note group but may be followed by a space, i.e. `=G,2-` . Open and close chord delimiters, `[` and `]`, should enclose entire note sequences (except for chord symbols), e.g.**
...
**The `W:` [information field](https://abcnotation.com/wiki/abc:standard:v2.1#information_field_definition "abc:standard:v2.1 ↵") (uppercase W) can be used for lyrics to be printed separately below the tune.**

**The `w:` [information field](https://abcnotation.com/wiki/abc:standard:v2.1#information_field_definition "abc:standard:v2.1 ↵") (lowercase w) in the [tune body](https://abcnotation.com/wiki/abc:standard:v2.1#tune_body_definition "abc:standard:v2.1 ↵"), supplies lyrics to be aligned syllable by syllable with previous notes of the current voice.**

### **5.1 Alignment**

**When adjacent, `w:` fields indicate different verses ([see below](https://abcnotation.com/wiki/abc:standard:v2.1#verses "abc:standard:v2.1 ↵")), but for non-adjacent `w:` fields, the alignment of the lyrics:**
...
**Note that syllables are not aligned on [grace notes](https://abcnotation.com/wiki/abc:standard:v2.1#grace_notes "abc:standard:v2.1 ↵"), [rests](https://abcnotation.com/wiki/abc:standard:v2.1#rests "abc:standard:v2.1 ↵") or [spacers](https://abcnotation.com/wiki/abc:standard:v2.1#typesetting_extra_space "abc:standard:v2.1 ↵") and that tied, slurred or beamed notes are treated as separate notes in this context.**

**The lyrics lines are treated as [text strings](https://abcnotation.com/wiki/abc:standard:v2.1#text_string_definition "abc:standard:v2.1 ↵"). Within the lyrics, the words should be separated by one or more spaces and to correctly align them the following symbols may be used:**
...
**See [field continuation](https://abcnotation.com/wiki/abc:standard:v2.1#field_continuation "abc:standard:v2.1 ↵") for the meaning of the `+:` field continuation.**
...
-   **a **code line-break**, meaning a line-break in the abc [tune body](https://abcnotation.com/wiki/abc:standard:v2.1#tune_body_definition "abc:standard:v2.1 ↵"), and, in particular, at the end of a line of [music code](https://abcnotation.com/wiki/abc:standard:v2.1#music_code_definition "abc:standard:v2.1 ↵");**
    
-   **a **score line-break**, meaning a line-break in the printed score.**
    

**The fundamental mechanism for typesetting [score line-breaks](https://abcnotation.com/wiki/abc:standard:v2.1#score_line-break_definition "abc:standard:v2.1 ↵") is by using [code line-breaks](https://abcnotation.com/wiki/abc:standard:v2.1#code_line-break_definition "abc:standard:v2.1 ↵") - one line of [music code](https://abcnotation.com/wiki/abc:standard:v2.1#music_code_definition "abc:standard:v2.1 ↵") in the [tune body](https://abcnotation.com/wiki/abc:standard:v2.1#tune_body_definition "abc:standard:v2.1 ↵") normally corresponds to one line of printed music.**

**Of course the printed representation of a line of [music code](https://abcnotation.com/wiki/abc:standard:v2.1#music_code_definition "abc:standard:v2.1 ↵") may be too long for the staff, so if necessary, typesetting programs should introduce additional [score line-breaks](https://abcnotation.com/wiki/abc:standard:v2.1#score_line-break_definition "abc:standard:v2.1 ↵"). As a consequence, if you would prefer [score line-breaks](https://abcnotation.com/wiki/abc:standard:v2.1#score_line-break_definition "abc:standard:v2.1 ↵") to be handled completely automatically (as is common in non-abc scoring software), then just type the [tune body](https://abcnotation.com/wiki/abc:standard:v2.1#tune_body_definition "abc:standard:v2.1 ↵") on a single line of [music code](https://abcnotation.com/wiki/abc:standard:v2.1#music_code_definition "abc:standard:v2.1 ↵").**

**Even though most abc GUI software should wrap over-long lines, typing the [tune body](https://abcnotation.com/wiki/abc:standard:v2.1#tune_body_definition "abc:standard:v2.1 ↵") on a single line may not always be convenient, particularly for users who wish to include [code line-breaks](https://abcnotation.com/wiki/abc:standard:v2.1#code_line-break_definition "abc:standard:v2.1 ↵") to aid readability or if the abc code is to be emailed (see [continuation of input lines](https://abcnotation.com/wiki/abc:standard:v2.1#continuation_of_input_lines "abc:standard:v2.1 ↵")).**

**Furthermore, in the past some typesetting programs used `!` characters in the abc code to force [score line-breaks](https://abcnotation.com/wiki/abc:standard:v2.1#score_line-break_definition "abc:standard:v2.1 ↵").**

**As a result, abc 2.1 introduces a new line-breaking instruction.**

##### **I:linebreak**

**To allow for all line-breaking preferences, the `I:linebreak` instruction may be used, together with four possible values, to control [score line-breaking](https://abcnotation.com/wiki/abc:standard:v2.1#score_line-break_definition "abc:standard:v2.1 ↵").**

-   **"`I:linebreak $`" indicates that the `$` symbol is used in the [tune body](https://abcnotation.com/wiki/abc:standard:v2.1#tune_body_definition "abc:standard:v2.1 ↵") to typeset a [score line-break](https://abcnotation.com/wiki/abc:standard:v2.1#score_line-break_definition "abc:standard:v2.1 ↵"). Any [code line-breaks](https://abcnotation.com/wiki/abc:standard:v2.1#code_line-break_definition "abc:standard:v2.1 ↵") are ignored for typesetting purposes.**
...
-   **"`I:linebreak !`" indicates that the `!` symbol is used to typeset a [score line-break](https://abcnotation.com/wiki/abc:standard:v2.1#score_line-break_definition "abc:standard:v2.1 ↵"). Any [code line-breaks](https://abcnotation.com/wiki/abc:standard:v2.1#code_line-break_definition "abc:standard:v2.1 ↵") are ignored for typesetting purposes.**
    

**_Comment:_ The "`I:linebreak !`" instruction works in the same way as `I:linebreak $` and is primarily provided for backwards compatibility - see [line-breaking dialects](https://abcnotation.com/wiki/abc:standard:v2.1#line-breaking_dialects "abc:standard:v2.1 ↵"), so that "`I:linebreak $`" is the preferred usage. "`I:linebreak !`" also automatically invokes the "`I:decoration +`" instruction - see [decoration dialects](https://abcnotation.com/wiki/abc:standard:v2.1#decoration_dialects "abc:standard:v2.1 ↵"). Finally, "`I:linebreak !`" is equivalent to the [deprecated](https://abcnotation.com/wiki/abc:standard:v2.1#outdated_syntax "abc:standard:v2.1 ↵") directive `%%continueall true` - see [outdated directives](https://abcnotation.com/wiki/abc:standard:v2.1#outdated_directives "abc:standard:v2.1 ↵").**

-   **"`I:linebreak <EOL>`" indicates that the End Of Line character (CR, LF or CRLF) is used to typeset a [score line-break](https://abcnotation.com/wiki/abc:standard:v2.1#score_line-break_definition "abc:standard:v2.1 ↵"). In other words, [code line-breaks](https://abcnotation.com/wiki/abc:standard:v2.1#code_line-break_definition "abc:standard:v2.1 ↵") are used for typesetting [score line-breaks](https://abcnotation.com/wiki/abc:standard:v2.1#score_line-break_definition "abc:standard:v2.1 ↵").**
    

-   **"`I:linebreak <none>`" indicates that all line-breaking is to be carried out automatically and any [code line-breaks](https://abcnotation.com/wiki/abc:standard:v2.1#code_line-break_definition "abc:standard:v2.1 ↵") are ignored for typesetting purposes.**
    

**The values `<EOL>`, `$` and `!` may also be combined so that more that one symbol can indicate a [score line-break](https://abcnotation.com/wiki/abc:standard:v2.1#score_line-break_definition "abc:standard:v2.1 ↵").**

**The default line-break setting is:**

**I:linebreak <EOL> $**

**meaning that both [code line-breaks](https://abcnotation.com/wiki/abc:standard:v2.1#code_line-break_definition "abc:standard:v2.1 ↵"), and `$` symbols, generate a [score line-break](https://abcnotation.com/wiki/abc:standard:v2.1#score_line-break_definition "abc:standard:v2.1 ↵").**

**_Comment:_ Although "`I:linebreak $ !`" is legal it is not recommended as it uses two different symbols to mean the same thing.**

**An `I:linebreak` instruction can be used either in the [file header](https://abcnotation.com/wiki/abc:standard:v2.1#file_header_definition "abc:standard:v2.1 ↵") (in which case it is applied to every [tune](https://abcnotation.com/wiki/abc:standard:v2.1#abc_tune_definition "abc:standard:v2.1 ↵") in the [abc file](https://abcnotation.com/wiki/abc:standard:v2.1#abc_file_definition "abc:standard:v2.1 ↵")), or in a [tune header](https://abcnotation.com/wiki/abc:standard:v2.1#tune_header_definition "abc:standard:v2.1 ↵") (in which case it is applied to that tune only and overrides a line-breaking instruction in the [file header](https://abcnotation.com/wiki/abc:standard:v2.1#file_header_definition "abc:standard:v2.1 ↵")). Similarly, if two `I:linebreak` instructions appear in a [file header](https://abcnotation.com/wiki/abc:standard:v2.1#file_header_definition "abc:standard:v2.1 ↵") or a [tune header](https://abcnotation.com/wiki/abc:standard:v2.1#tune_header_definition "abc:standard:v2.1 ↵"), the second cancels the first.**

**_Comment:_ It can be sometimes be useful to include two instructions together - for example, "`I:linebreak <EOL> $`" and "`I:linebreak <none>`" can be used to toggle between default and automatic line-breaking simply by swapping the position of the two lines.**

**`I:linebreak` instructions are not allowed in the [tune body](https://abcnotation.com/wiki/abc:standard:v2.1#tune_body_definition "abc:standard:v2.1 ↵") (principally because it conflicts with the human readability of the [music code](https://abcnotation.com/wiki/abc:standard:v2.1#music_code_definition "abc:standard:v2.1 ↵")).** 

##### **Suppressing score line-breaks**

**When the `<EOL>` character is being used in the [tune body](https://abcnotation.com/wiki/abc:standard:v2.1#tune_body_definition "abc:standard:v2.1 ↵") to indicate [score line-breaks](https://abcnotation.com/wiki/abc:standard:v2.1#score_line-break_definition "abc:standard:v2.1 ↵"), it sometimes useful to be able to tell typesetting software to ignore a particular [code line-breaks](https://abcnotation.com/wiki/abc:standard:v2.1#code_line-break_definition "abc:standard:v2.1 ↵"). This is achieved using a backslash (`\`) at the end of a line of [music code](https://abcnotation.com/wiki/abc:standard:v2.1#music_code_definition "abc:standard:v2.1 ↵"). The backslash may be followed by trailing whitespace and/or [comments](https://abcnotation.com/wiki/abc:standard:v2.1#comment_definition "abc:standard:v2.1 ↵"), since they are removed before the line is processed.**

**_Example:_ The following two excerpts are considered equivalent and should be typeset as a single staff in the printed score.**
...
**There is no limit to the number of lines that may be joined together in this way. However, a backslash must not be used before an [empty line](https://abcnotation.com/wiki/abc:standard:v2.1#empty_line_definition "abc:standard:v2.1 ↵").**
...
**In the examples above, where a line of [music code](https://abcnotation.com/wiki/abc:standard:v2.1#music_code_definition "abc:standard:v2.1 ↵") follows immediately after a line ending in backslash, the backslash acts as a continuation for two lines of [music code](https://abcnotation.com/wiki/abc:standard:v2.1#music_code_definition "abc:standard:v2.1 ↵") and can therefore be used to split up long [music code](https://abcnotation.com/wiki/abc:standard:v2.1#music_code_definition "abc:standard:v2.1 ↵") lines.**

**More importantly, however, any [information fields](https://abcnotation.com/wiki/abc:standard:v2.1#information_field_definition "abc:standard:v2.1 ↵") and [stylesheet directives](https://abcnotation.com/wiki/abc:standard:v2.1#stylesheet_directive_definition "abc:standard:v2.1 ↵")are processed (and [comments](https://abcnotation.com/wiki/abc:standard:v2.1#comment_definition "abc:standard:v2.1 ↵") are removed) at the point where the physical line-break occurs. Hence the backslash is commonly used to include meter or key changes halfway through a line of music.**

**_Example:_ The following should be typeset as a single staff in the printed score.**
...
**_Alternative usage example:_ The above could also be achieved using [inline fields](https://abcnotation.com/wiki/abc:standard:v2.1#inline_field_definition "abc:standard:v2.1 ↵"), the `[I:<directive>](https://abcnotation.com/wiki/abc:standard:v2.1#iinstruction "abc:standard:v2.1 ↵")` form instead of `%%<directive>` and a `[r:remark](https://abcnotation.com/wiki/abc:standard:v2.1#comments_and_remarks "abc:standard:v2.1 ↵")` in place of the [comment](https://abcnotation.com/wiki/abc:standard:v2.1#comment_definition "abc:standard:v2.1 ↵"), i.e.**

**abc cab|[I:setbarnb 10][M:9/8][r:comment]abc cba abc|**

**Finally, note that if the the `<EOL>` character is not being used to indicate [score line-breaks](https://abcnotation.com/wiki/abc:standard:v2.1#score_line-break_definition "abc:standard:v2.1 ↵"), then the backslash is effectively redundant.**

**_Recommendation to users:_ If you find that you are using backslash symbols on most lines of [music code](https://abcnotation.com/wiki/abc:standard:v2.1#music_code_definition "abc:standard:v2.1 ↵"), then consider instead using "`I:linebreak <none>`" or "`I:linebreak $`" which will mean that all the [code line-breaks](https://abcnotation.com/wiki/abc:standard:v2.1#code_line-break_definition "abc:standard:v2.1 ↵")will be ignored for the purposes of generating [score line-breaks](https://abcnotation.com/wiki/abc:standard:v2.1#score_line-break_definition "abc:standard:v2.1 ↵") (and, in the latter case, you can encode a [score line-breaks](https://abcnotation.com/wiki/abc:standard:v2.1#score_line-break_definition "abc:standard:v2.1 ↵") with the `$` character).**

#### **6.1.2 Typesetting extra space**

**`y` can be used to add extra space between the surrounding notes; moreover, [chord symbols](https://abcnotation.com/wiki/abc:standard:v2.1#chord_symbols "abc:standard:v2.1 ↵") and [decorations](https://abcnotation.com/wiki/abc:standard:v2.1#decorations "abc:standard:v2.1 ↵") can be attached to it, to separate them from notes.**

**_Example:_** 

**"Am" !pp! y**

**Note that the `y` symbol does _not_ create [rests](https://abcnotation.com/wiki/abc:standard:v2.1#rests "abc:standard:v2.1 ↵") in the music.**
...
-   **each `P:part` in the [tune body](https://abcnotation.com/wiki/abc:standard:v2.1#tune_body_definition "abc:standard:v2.1 ↵") should have the string identifying it printed immediately above the start of that part; if there is a `P:parts` field in the [tune header](https://abcnotation.com/wiki/abc:standard:v2.1#tune_header_definition "abc:standard:v2.1 ↵") (describing which order the parts are played in) it should be printed left-aligned above the start of the tune**
    
-   **the `Q:tempo` should be printed above the tune at the start of the section to which it applies**
    
-   **the aligned `w:words` (lyrics) should be printed under each line of music with other `W:words` printed beneath the tune - see [lyrics](https://abcnotation.com/wiki/abc:standard:v2.1#lyrics "abc:standard:v2.1 ↵")**
    

**To suppress any of these, or alternatively to typeset additional [information fields](https://abcnotation.com/wiki/abc:standard:v2.1#information_field_definition "abc:standard:v2.1 ↵") such as notes (N), history (H), rhythm (R), book (B), discography (D), file (F), source (S) or transcription (Z), use the `%%writefields` directive - see [information directives](https://abcnotation.com/wiki/abc:standard:v2.1#information_directives "abc:standard:v2.1 ↵").**

**To customise the typesetting (for example, by changing the font), see [formatting directives](https://abcnotation.com/wiki/abc:standard:v2.1#formatting_directives "abc:standard:v2.1 ↵").**

### **6.2 Playback**

**Many of the [information fields](https://abcnotation.com/wiki/abc:standard:v2.1#information_field_definition "abc:standard:v2.1 ↵") are ignored by playback programs - exceptions are `I:`, `K:`, `L:`, `M:`, `m:`, `P;`, `Q:`, `s:`, `U:` and `V:`.**
...
**Most playback customisation is handled by [instrumentation directives](https://abcnotation.com/wiki/abc:standard:v2.1#instrumentation_directives "abc:standard:v2.1 ↵").**
...
**_VOLATILE:_ Multi-voice music is under active review, with discussion about control voices and interaction between `P:`, `V:` and `T:` fields. It is intended that the syntax will be finalised in abc 2.2.**

**The `V:` field allows the writing of multi-voice music. In multi-voice [abc tunes](https://abcnotation.com/wiki/abc:standard:v2.1#abc_tune_definition "abc:standard:v2.1 ↵"), the [tune body](https://abcnotation.com/wiki/abc:standard:v2.1#tune_body_definition "abc:standard:v2.1 ↵") is divided into several voices, each beginning with a `V:` field. All the notes following such a `V:` field, up to the next `V:` field or the end of the [tune body](https://abcnotation.com/wiki/abc:standard:v2.1#tune_body_definition "abc:standard:v2.1 ↵"), belong to the voice.**

**The basic syntax of the field is:**

**V:ID**

**where ID can be either a number or a string, that uniquely identifies the voice in question. When using a string, only the first 20 characters of it will be distinguished. The ID will not be printed on the staff; it's only function is to indicate, throughout the [abc tune](https://abcnotation.com/wiki/abc:standard:v2.1#abc_tune_definition "abc:standard:v2.1 ↵"), which music line belongs to which voice.**
...
**[![](https://abcnotation.com/wiki/_media/abc:standard:multivoice-80.png)](https://abcnotation.com/wiki/_detail/abc:standard:multivoice-80.png?id=abc%3Astandard%3Av2.1 "abc:standard:multivoice-80.png")**

**`V:` can appear both in the body and the header. In the latter case, `V:` is used exclusively to set voice properties. For example, the `name` property in the example above, specifies which label should be printed on the first staff of the voice in question. Note that these properties may be also set or changed in the [tune body](https://abcnotation.com/wiki/abc:standard:v2.1#tune_body_definition "abc:standard:v2.1 ↵"). The `V:` properties are fully explained [below](https://abcnotation.com/wiki/abc:standard:v2.1#voice_properties "abc:standard:v2.1 ↵").**

**Please note that the exact grouping of voices on the staff or staves is not specified by `V:` itself. This may be specified with the `%%score` [stylesheet directive](https://abcnotation.com/wiki/abc:standard:v2.1#stylesheet_directive_definition "abc:standard:v2.1 ↵"). See [voice grouping](https://abcnotation.com/wiki/abc:standard:v2.1#voice_grouping "abc:standard:v2.1 ↵") for details.** 

**For playback, see [instrumentation directives](https://abcnotation.com/wiki/abc:standard:v2.1#instrumentation_directives "abc:standard:v2.1 ↵") for details of how to assign a General MIDI instrument to a voice using a `%%MIDI` [stylesheet directive](https://abcnotation.com/wiki/abc:standard:v2.1#stylesheet_directive_definition "abc:standard:v2.1 ↵").**

**Although it is not recommended, the [tune body](https://abcnotation.com/wiki/abc:standard:v2.1#tune_body_definition "abc:standard:v2.1 ↵") of fragment `X:1`, could also be notated this way:**
...
**_VOLATILE:_ See [above](https://abcnotation.com/wiki/abc:standard:v2.1#multiple_voices "abc:standard:v2.1 ↵").**
...
-   ****clef=** - specifies a clef; see [clefs and transposition](https://abcnotation.com/wiki/abc:standard:v2.1#clefs_and_transposition "abc:standard:v2.1 ↵") for details.**
    

**The name specifier may be abbreviated to `nm=`. The subname specifier may be abbreviated to `snm=`.**

**Applications may implement their own specifiers, but must gracefully ignore specifiers they don't understand or implement. This is required for portability of [abc files](https://abcnotation.com/wiki/abc:standard:v2.1#abc_file_definition "abc:standard:v2.1 ↵") between applications.**

### **7.2 Breaking lines**

**_VOLATILE:_ See [above](https://abcnotation.com/wiki/abc:standard:v2.1#multiple_voices "abc:standard:v2.1 ↵"). In particular the following may be relaxed with the introduction of a control voice.**

**The rules for [typesetting line-breaks](https://abcnotation.com/wiki/abc:standard:v2.1#typesetting_line-breaks "abc:standard:v2.1 ↵") in multi-voice [abc tunes](https://abcnotation.com/wiki/abc:standard:v2.1#abc_tune_definition "abc:standard:v2.1 ↵") are the same as for single voice music although additionally a line-break in one voice must be matched in the other voices. See the example tune [Canzonetta.abc](https://abcnotation.com/wiki/abc:standard:v2.1#canzonettaabc "abc:standard:v2.1 ↵").**

### **7.3 Inline fields**

**_VOLATILE:_ See [above](https://abcnotation.com/wiki/abc:standard:v2.1#multiple_voices "abc:standard:v2.1 ↵").**

**To avoid ambiguity, [inline fields](https://abcnotation.com/wiki/abc:standard:v2.1#inline_field_definition "abc:standard:v2.1 ↵") that specify music properties should be repeated in every voice to which they apply.**
...
**[![](https://abcnotation.com/wiki/_media/abc:standard:overlay1-80.png)](https://abcnotation.com/wiki/_detail/abc:standard:overlay1-80.png?id=abc%3Astandard%3Av2.1 "abc:standard:overlay1-80.png")**

**Words in `w:` lines (and symbols in `s:` lines) are matched to the corresponding notes as per the normal rules for lyric alignment (see [lyrics](https://abcnotation.com/wiki/abc:standard:v2.1#lyrics "abc:standard:v2.1 ↵")), disregarding any overlay in the accompanying [music code](https://abcnotation.com/wiki/abc:standard:v2.1#music_code_definition "abc:standard:v2.1 ↵").**
...
**[![](https://abcnotation.com/wiki/_media/abc:standard:overlay3-80.png)](https://abcnotation.com/wiki/_detail/abc:standard:overlay3-80.png?id=abc%3Astandard%3Av2.1 "abc:standard:overlay3-80.png")**

**This revokes the abc 2.0 usage of `&` in `w:` and `s:` lines, which is now [deprecated](https://abcnotation.com/wiki/abc:standard:v2.1#outdated_syntax "abc:standard:v2.1 ↵")(see [disallowed](https://abcnotation.com/wiki/abc:standard:v2.1#disallowed_voice_overlay "abc:standard:v2.1 ↵")).**
...
**Within the [tune body](https://abcnotation.com/wiki/abc:standard:v2.1#tune_body_definition "abc:standard:v2.1 ↵"), all the printable ASCII characters may be used for the [music code](https://abcnotation.com/wiki/abc:standard:v2.1#music_code_definition "abc:standard:v2.1 ↵"). These are:**
...
**To ensure forward compatibility, current software should ignore these characters when they appear inside or between note groups, possibly giving a warning. However, these characters may not be ignored when they appear inside [text strings](https://abcnotation.com/wiki/abc:standard:v2.1#text_string_definition "abc:standard:v2.1 ↵") or [information fields](https://abcnotation.com/wiki/abc:standard:v2.1#information_field_definition "abc:standard:v2.1 ↵").**
...
**Text written within an [abc file](https://abcnotation.com/wiki/abc:standard:v2.1#abc_file_definition "abc:standard:v2.1 ↵"), either as part of an [information field](https://abcnotation.com/wiki/abc:standard:v2.1#information_field_definition "abc:standard:v2.1 ↵"), an [annotation](https://abcnotation.com/wiki/abc:standard:v2.1#annotations "abc:standard:v2.1 ↵") or as [free text](https://abcnotation.com/wiki/abc:standard:v2.1#free_text_definition "abc:standard:v2.1 ↵") / [typeset text](https://abcnotation.com/wiki/abc:standard:v2.1#typeset_text_definition "abc:standard:v2.1 ↵"), is known as a **text string**, or more fully, an **abc text string**. (Note that the abc standard version 2.0 referred to a [text string](https://abcnotation.com/wiki/abc:standard:v2.1#text_string_definition "abc:standard:v2.1 ↵") as an _abc string_.)**

**Typically when there are several lines of text, each line forms a separate [text string](https://abcnotation.com/wiki/abc:standard:v2.1#text_string_definition "abc:standard:v2.1 ↵"), although the distinction is not essential.** 

**The contents of a text string may be written using any legal [character set](https://abcnotation.com/wiki/abc:standard:v2.1#charset_field "abc:standard:v2.1 ↵"). The default character set is `utf-8`, giving access to every Unicode character.**
...
-   ****mnemonics** - for example, é can be represented by `\'e`. These mnemonics are are based on TeX encodings and are always in the format _backslash-mnemonic-letter_. They have been available since the earliest days of abc and are widely used in legacy abc files. They are generally easy to remember and easy to read, but are not comprehensive in terms of the possible accents they can represent.**
...
**All conforming abc typesetting software should support (understand and be able to convert) the subset of accents and ligatures given in the appendix, [supported accents & ligatures](https://abcnotation.com/wiki/abc:standard:v2.1#supported_accents_ligatures "abc:standard:v2.1 ↵"), together with the special characters and symbols listed below.**
...
**_Examples:_ When reduced to the base letter, `\oA` becomes  `A`, `\"o` becomes `o`, `\ss`becomes `ss`, `\AE` becomes `AE`, etc.**
...
**Characters that are meaningful in the context of a [text string](https://abcnotation.com/wiki/abc:standard:v2.1#text_string_definition "abc:standard:v2.1 ↵") can be escaped using a backslash as follows:**

-   **type `\\` to get a backslash;**
    
-   **type `\%` to get a percent symbol that is not interpreted as the start of a [comment](https://abcnotation.com/wiki/abc:standard:v2.1#comments_and_remarks "abc:standard:v2.1 ↵");**
...
-   **type `&quot;` or `\u0022` to get double quote marks in an [annotation](https://abcnotation.com/wiki/abc:standard:v2.1#annotations "abc:standard:v2.1 ↵")**
...
**_VOLATILE:_ Finally note that currently the specifiers `$1`, `$2`, `$3` and `$4` can be used to change the font within a [text string](https://abcnotation.com/wiki/abc:standard:v2.1#text_string_definition "abc:standard:v2.1 ↵"). However, this feature is likely to change in future versions of the standard - see [font directives](https://abcnotation.com/wiki/abc:standard:v2.1#font_directives "abc:standard:v2.1 ↵") for more details.**
...
**Software implementing these macros, should first expand the macros defined in this section, and only afterwards apply any relevant `U:` replacement (see [Redefinable symbols](https://abcnotation.com/wiki/abc:standard:v2.1#redefinable_symbols "abc:standard:v2.1 ↵")).**

**When these macros are stored in an abc header file (see [include field](https://abcnotation.com/wiki/abc:standard:v2.1#include_field "abc:standard:v2.1 ↵")), they may form a powerful library.**

**There are two kinds of macro, called Static and Transposing.**

### **9.1 Static macros**

**You define a static macro by writing into the [tune header](https://abcnotation.com/wiki/abc:standard:v2.1#tune_header_definition "abc:standard:v2.1 ↵") something like this:**

 **m: ~G3 = G{A}G{F}G**

**When you play the tune, the program searches the [tune header](https://abcnotation.com/wiki/abc:standard:v2.1#tune_header_definition "abc:standard:v2.1 ↵") for macro definitions, then does a search and replace on its internal copy of the text before passing that to the parser which plays the tune. Every occurence of `~G3` in the tune is replaced by `G{A}G{F}G`, and that is what gets played. Only `~G3` notes are affected, `~G2`, `~g3`, `~F3` etc. are ignored.**
...
**_Comment:_ It is almost impossible to think of a way to transpose `~=a3` or `~^G2`which will work correctly under all circumstances, so a static macro should be used for cases like these.**
...
**The `A:` [field](https://abcnotation.com/wiki/abc:standard:v2.1#aarea "abc:standard:v2.1 ↵") was originally used to contain area information. In version 2.0 this was changed to contain the name of the lyrics author. In version 2.1, to maintain backwards compatibility, this has been changed back to area, but for clarity, the `A:` field is [deprecated](https://abcnotation.com/wiki/abc:standard:v2.1#outdated_syntax "abc:standard:v2.1 ↵") - area information can be stored in the `O:` field and a new field _(to be decided)_ will be used for author information.**

**_Comment:_ Of the 160,000 tunes currently available in the [abcnotation.com tune search](https://abcnotation.com/search "https://abcnotation.com/search") 16,300 contain an `A:` field with 680 distinct values. Of these, only around 10 contain author information rather than area (in some cases it is difficult to tell).**

**An `E:` field was once used by `abc2mtex` to explicitly control note spacing; this is no longer necessary with current formatting algorithms and the `E:` field is now [deprecated](https://abcnotation.com/wiki/abc:standard:v2.1#outdated_syntax "abc:standard:v2.1 ↵").**

**The original usage of the `H:` [history](https://abcnotation.com/wiki/abc:standard:v2.1#hhistory "abc:standard:v2.1 ↵") field, where the contents of the history field is considered to continue over several lines until the next field occurs, is now [deprecated](https://abcnotation.com/wiki/abc:standard:v2.1#outdated_syntax "abc:standard:v2.1 ↵").** 

**The `Q:` [tempo](https://abcnotation.com/wiki/abc:standard:v2.1#qtempo "abc:standard:v2.1 ↵") field is still very much in use, but earlier versions of the standard permitted two syntax variants, now [deprecated](https://abcnotation.com/wiki/abc:standard:v2.1#outdated_syntax "abc:standard:v2.1 ↵"), which specified how many unit note lengths to play per minute.**
...
**This is not very musical, and the usage is [deprecated](https://abcnotation.com/wiki/abc:standard:v2.1#outdated_syntax "abc:standard:v2.1 ↵"). However, there are many [abc files](https://abcnotation.com/wiki/abc:standard:v2.1#abc_file_definition "abc:standard:v2.1 ↵") which employ this syntax and programs should accept it.**

### **10.2 Outdated dialects**

#### **10.2.1 Outdated line-breaking**

**The popular abc software abc2win introduced an exclamation mark (`!`) as a way of forcing a [score line-break](https://abcnotation.com/wiki/abc:standard:v2.1#score_line-break_definition "abc:standard:v2.1 ↵") and this was adopted by abc 2.0, conflicting with the previous usage of `!…!` to delimit decorations.**

**The `!` is now [deprecated](https://abcnotation.com/wiki/abc:standard:v2.1#outdated_syntax "abc:standard:v2.1 ↵") for [score line-breaks](https://abcnotation.com/wiki/abc:standard:v2.1#score_line-break_definition "abc:standard:v2.1 ↵") although it is still available (even under [strict interpretation](https://abcnotation.com/wiki/abc:standard:v2.1#strict_interpretation "abc:standard:v2.1 ↵")) for legacy abc transcriptions by use of the "`I:linebreak !`" directive - see [line-breaking dialects](https://abcnotation.com/wiki/abc:standard:v2.1#line-breaking_dialects "abc:standard:v2.1 ↵").**

#### **10.2.2 Outdated decorations**

**Abc standard 2.0 adopted `+…+` syntax to indicate decorations in place of `!…!`. It never gained much favour, however, and the latter is in much more common (see [decoration dialects](https://abcnotation.com/wiki/abc:standard:v2.1#decoration_dialects "abc:standard:v2.1 ↵")).**

**Therefore, and since a non-conflicting mechanism has now been found to allow `!` for line-breaking (see [line-breaking dialects](https://abcnotation.com/wiki/abc:standard:v2.1#line-breaking_dialects "abc:standard:v2.1 ↵")), the `+…+` decoration syntax is now [deprecated](https://abcnotation.com/wiki/abc:standard:v2.1#outdated_syntax "abc:standard:v2.1 ↵") in favour of `!…!`.**

**Nonetheless, the `+…+` decoration syntax is still available using the "`I:decoration +`" instruction (see [decoration dialects](https://abcnotation.com/wiki/abc:standard:v2.1#decoration_dialects "abc:standard:v2.1 ↵")).**

#### **10.2.3 Outdated chords**

**Early versions of the abc standard used the `+` symbol to delimit chords (in place of `[]` symbols). This usage is now [deprecated](https://abcnotation.com/wiki/abc:standard:v2.1#outdated_syntax "abc:standard:v2.1 ↵") - see [chord dialects](https://abcnotation.com/wiki/abc:standard:v2.1#chord_dialects "abc:standard:v2.1 ↵") for more details.**

### **10.3 Outdated continuations**

**From the earliest days of abc (in abc standard 1.0 through to abc 1.7.6), the backslash (`\`) has been used to suppress [score line-breaks](https://abcnotation.com/wiki/abc:standard:v2.1#score_line-break_definition "abc:standard:v2.1 ↵") by placing it at the end of a line of [music code](https://abcnotation.com/wiki/abc:standard:v2.1#music_code_definition "abc:standard:v2.1 ↵"). Thus, effectively, it has acted as a continuation character, although with its own special rules, in particular that it could act through [information fields](https://abcnotation.com/wiki/abc:standard:v2.1#information_field_definition "abc:standard:v2.1 ↵") and [comments](https://abcnotation.com/wiki/abc:standard:v2.1#comment_definition "abc:standard:v2.1 ↵").**

**Abc 2.0 extended this usage to make `\` a general continuation character, which also allows continuation of [information fields](https://abcnotation.com/wiki/abc:standard:v2.1#information_field_definition "abc:standard:v2.1 ↵") and in particular the `w:` lyrics field (usually the only field which actually requires a continuation in typical transcriptions). Unfortunately, however, the rules of precedence were never well established (should the `\` be treated by a pre-processor joining together continued lines and, if so, should comments be removed before or after that happened?) and the usage was never widely adopted, nor even well understood.**

**_Comment:_ Of the 160,000 tunes currently available in the [abcnotation.com tune search](https://abcnotation.com/search "https://abcnotation.com/search"), only 22 (0.01%) use continuations for the `w:` field and only around 50 (0.03%) use it for any other field; of these latter usages, almost all are actually in error.**

**Furthermore, discussions during the development of abc 2.1 led to the suggestion that a new character should be introduced to suppress [score line-breaks](https://abcnotation.com/wiki/abc:standard:v2.1#score_line-break_definition "abc:standard:v2.1 ↵") - in other words the `\` (as described in abc 2.0) had evolved far enough away from its initial definition so that another character was required to replace what it had originally been designed to do.**

**Consequently, in abc 2.1 the `\` has been reinstated to its original purpose of suppressing [score line-breaks](https://abcnotation.com/wiki/abc:standard:v2.1#score_line-break_definition "abc:standard:v2.1 ↵") (see [typesetting line-breaks](https://abcnotation.com/wiki/abc:standard:v2.1#typesetting_line-breaks "abc:standard:v2.1 ↵")) and its use a general continuation character is now [disallowed](https://abcnotation.com/wiki/abc:standard:v2.1#outdated_syntax "abc:standard:v2.1 ↵") (see [continuation of input lines](https://abcnotation.com/wiki/abc:standard:v2.1#continuation_of_input_lines "abc:standard:v2.1 ↵") for the alternatives).** 

### **10.4 Outdated directives**

**The `%%continueall true` directive is replaced by "`I:linebreak !`" in abc 2.1 (see [typesetting line-breaks](https://abcnotation.com/wiki/abc:standard:v2.1#typesetting_line-breaks "abc:standard:v2.1 ↵")) and [deprecated](https://abcnotation.com/wiki/abc:standard:v2.1#outdated_syntax "abc:standard:v2.1 ↵").**

**The `%%abc-copyright` and `%%abc-edited-by` extended information fields from section 3.3. of abc 2.0 have been [deprecated](https://abcnotation.com/wiki/abc:standard:v2.1#outdated_syntax "abc:standard:v2.1 ↵") in favour of the [Z: - transcription](https://abcnotation.com/wiki/abc:standard:v2.1#ztranscription "abc:standard:v2.1 ↵")field.**

**_Comment:_ Of the 131,000 files currently available in the [abcnotation.com tune search](https://abcnotation.com/search "https://abcnotation.com/search") only 32 use `%%abc-edited-by` and only 1 uses `%%abc-copyright`.**

### **10.5 Outdated file structure**

#### **10.5.1 Outdated tune header syntax**

**Abc standard 2.0 included the rule that 'if the [abc file](https://abcnotation.com/wiki/abc:standard:v2.1#abc_file_definition "abc:standard:v2.1 ↵") contains only one tune the `X:` field may be dropped'. However, it was pointed out that as a consequence, a user who pasted an additional tune into such a file would get an error message from a tune which previously contained no errors.**

**Despite considerable discussion on the abcusers mail list (see for example the threads [http://tech.groups.yahoo.com/group/abcusers/message/3950](http://tech.groups.yahoo.com/group/abcusers/message/3950 "http://tech.groups.yahoo.com/group/abcusers/message/3950") and [http://tech.groups.yahoo.com/group/abcusers/message/4113](http://tech.groups.yahoo.com/group/abcusers/message/4113 "http://tech.groups.yahoo.com/group/abcusers/message/4113")) and, a number of good suggestions, no consensus was reached. As a result the above rule is [deprecated](https://abcnotation.com/wiki/abc:standard:v2.1#outdated_syntax "abc:standard:v2.1 ↵") in abc 2.1; a tune must start with a `X:` field followed by a `T:` field.**

**However, this decision may be revisited in the future and the specification relaxed.**

#### **10.5.2 Outdated defaults**

**In early versions of the abc standard, defaults could be set throughout an [abc file](https://abcnotation.com/wiki/abc:standard:v2.1#abc_file_definition "abc:standard:v2.1 ↵"), using [information fields](https://abcnotation.com/wiki/abc:standard:v2.1#information_field_definition "abc:standard:v2.1 ↵"), which applied to all subsequent tune. In other words, the [file header](https://abcnotation.com/wiki/abc:standard:v2.1#file_header_definition "abc:standard:v2.1 ↵") could effectively appear anywhere inside a file instead of just at the top.**

**This usage significantly complicates random access of the tunes in the file, since the all the preceding contents of the file must be scanned for default settings before a tune can be processed. As result this was [deprecated](https://abcnotation.com/wiki/abc:standard:v2.1#outdated_syntax "abc:standard:v2.1 ↵") in abc 2.0 and is [deprecated](https://abcnotation.com/wiki/abc:standard:v2.1#outdated_syntax "abc:standard:v2.1 ↵") in abc 2.1.**

### **10.6 Outdated lyrics alignment**

**Abc 2.1 introduced an extension to [lyrics alignment](https://abcnotation.com/wiki/abc:standard:v2.1#alignment "abc:standard:v2.1 ↵") meaning that lyric lines (i.e. those using the `w:` field) no longer need to follow immediately after the line of [music code](https://abcnotation.com/wiki/abc:standard:v2.1#music_code_definition "abc:standard:v2.1 ↵") to which they are attached, meaning that they can even be postponed to the end of the [tune body](https://abcnotation.com/wiki/abc:standard:v2.1#tune_body_definition "abc:standard:v2.1 ↵").**

**_Examples:_ The following two excerpts are equivalent in abc 2.1; under abc 2.0 and previous versions of the standard, only the first version would be legal. Note that there are 4 ([numbered](https://abcnotation.com/wiki/abc:standard:v2.1#numbering "abc:standard:v2.1 ↵")) verses and hence 4 `w:` fields for each line of [music code](https://abcnotation.com/wiki/abc:standard:v2.1#music_code_definition "abc:standard:v2.1 ↵").**

**In the first excerpt the lyrics follow immediately after the line of [music code](https://abcnotation.com/wiki/abc:standard:v2.1#music_code_definition "abc:standard:v2.1 ↵") to which they are attached.**

**In the second excerpt, the lyrics are postponed to the end of the tune, arguably aiding readability substantially and meaning that each verse is contiguous. The [comment lines](https://abcnotation.com/wiki/abc:standard:v2.1#comment_definition "abc:standard:v2.1 ↵") in the second excerpt (those lines beginning with `%`) are added for readability and are entirely optional.**
...
**_Example:_ In the following excerpt, using abc 2.0 the lyrics would be aligned with the adjacent [music code](https://abcnotation.com/wiki/abc:standard:v2.1#music_code_definition "abc:standard:v2.1 ↵"), i.e. with `cdef`; using abc 2.1 they would be aligned at the start of the tune (or voice), i.e. with `CDEF`.**
...
**The work around for users who have files with such usage is either to avoid writing `%abc-2.1` as the [file identifier](https://abcnotation.com/wiki/abc:standard:v2.1#abc_file_identification "abc:standard:v2.1 ↵") or to add an empty `w:` field after the final line of [music code](https://abcnotation.com/wiki/abc:standard:v2.1#music_code_definition "abc:standard:v2.1 ↵") that should be without lyrics.**

**_Example:_ The following excerpt should be treated the same way (with regard to lyrics alignment) under abc 2.0 and abc 2.1. Under abc 2.1 the empty `w:` field means that the lyrics are aligned with `cdef`.**
...
**Although the use of ampersand (`&`) to overlay voices (as introduced in abc 2.0) is still perfectly acceptable, this usage has been [deprecated](https://abcnotation.com/wiki/abc:standard:v2.1#outdated_syntax "abc:standard:v2.1 ↵") within `w:` lyric and `s:` symbol [information fields](https://abcnotation.com/wiki/abc:standard:v2.1#information_field_definition "abc:standard:v2.1 ↵").**
...
**Instead lyrics are matched to notes without regard to the voice overlay - see [voice overlay](https://abcnotation.com/wiki/abc:standard:v2.1#voice_overlay "abc:standard:v2.1 ↵").**
...
**In the early days of abc, pseudo-comments (lines starting with `%%`) were introduced as a means of adding software-specific information and formatting instructions into [abc files](https://abcnotation.com/wiki/abc:standard:v2.1#abc_file_definition "abc:standard:v2.1 ↵"); because they started with a `%` symbol software that didn't recognise them would ignore them as a [comment](https://abcnotation.com/wiki/abc:standard:v2.1#comment_definition "abc:standard:v2.1 ↵").**

**In a valiant effort, abc 2.0 made an attempt to standardise these pseudo-comments with the introduction [stylesheet directives](https://abcnotation.com/wiki/abc:standard:v2.1#stylesheet_directive_definition "abc:standard:v2.1 ↵") and the abc stylesheet specification. This was described as "not part of the ABC specification itself" but as "an additional standard" containing directives to control how the content and structural information described by the abc code "is to be actually rendered, for example by a typesetting or player program".**

**Unfortunately, however, there are a very large number of pseudo-comment directives and not all of them are well-defined. Furthermore, some directives, in particular the [text directives](https://abcnotation.com/wiki/abc:standard:v2.1#text_directives "abc:standard:v2.1 ↵") and [accidental directives](https://abcnotation.com/wiki/abc:standard:v2.1#accidental_directives "abc:standard:v2.1 ↵"), actually contain content and / or structural information (as opposed to rendering instructions).**

**Abc 2.1 has stepped away from this approach somewhat.**

**The pseudo-comments are still very much accepted as a way for developers to introduce experimental features and software-specific formatting instructions. However, when a directive gains acceptance, either by being implemented in more than one piece of software, or by its use in a substantial body of tunes, the aim is that the usage will be standardised and adopted in the standard and the `I:` [instruction](https://abcnotation.com/wiki/abc:standard:v2.1#iinstruction "abc:standard:v2.1 ↵") form recommended in place of the `%%` pseudo-comment form.**
...
**For the moment, section 11 is retained mostly unchanged from abc 2.0 (save for typo corrections) but, as a result of the foregoing, the whole of section 11 and all stylesheet directives should regarded as _VOLATILE_.**
...
**Alternatively, any [stylesheet directive](https://abcnotation.com/wiki/abc:standard:v2.1#stylesheet_directive_definition "abc:standard:v2.1 ↵") may be written as an `[I:instruction](https://abcnotation.com/wiki/abc:standard:v2.1#iinstruction "abc:standard:v2.1 ↵")`field although this is not recommended for usages which have not been standardised (i.e. it is not recommended for any directives described in section 11).**
...
**[Inline field](https://abcnotation.com/wiki/abc:standard:v2.1#inline_field_definition "abc:standard:v2.1 ↵") notation may be used to place a [stylesheet directive](https://abcnotation.com/wiki/abc:standard:v2.1#stylesheet_directive_definition "abc:standard:v2.1 ↵") in the middle of a line of music:**

**_Example:_** 

**CDEFG|[I:setbarnb 10]ABc**

**If a program doesn't recognise a [stylesheet directive](https://abcnotation.com/wiki/abc:standard:v2.1#stylesheet_directive_definition "abc:standard:v2.1 ↵"), it should just ignore it.**

**It should be stressed that the [stylesheet directives](https://abcnotation.com/wiki/abc:standard:v2.1#stylesheet_directive_definition "abc:standard:v2.1 ↵") are not formally part of the abc standard itself. Furthermore, the list of possible [directives](https://abcnotation.com/wiki/abc:standard:v2.1#stylesheet_directive_definition "abc:standard:v2.1 ↵") is long and not standardised. They are provided by a variety of programs for specifying layout, text annotations, fonts, spacings, voice instruments, transposition and other details.**

**Strictly speaking, abc applications don't have to conform to the same set of [stylesheet directives](https://abcnotation.com/wiki/abc:standard:v2.1#stylesheet_directive_definition "abc:standard:v2.1 ↵"). However, it is desirable that they do in order to make [abc files](https://abcnotation.com/wiki/abc:standard:v2.1#abc_file_definition "abc:standard:v2.1 ↵") portable between different computer systems.**

### **11.1 Voice grouping**

**_VOLATILE:_ This section is under review as part of the general discussion about [multiple voices](https://abcnotation.com/wiki/abc:standard:v2.1#multiple_voices "abc:standard:v2.1 ↵") for abc 2.2. See also the [section 11 disclaimer](https://abcnotation.com/wiki/abc:standard:v2.1#disclaimer "abc:standard:v2.1 ↵").**
...
**Any voices appearing in the [tune body](https://abcnotation.com/wiki/abc:standard:v2.1#tune_body_definition "abc:standard:v2.1 ↵") will only be printed if it is mentioned in the score directive.**

**When the score directive occurs within the [tune body](https://abcnotation.com/wiki/abc:standard:v2.1#tune_body_definition "abc:standard:v2.1 ↵"), it resets the music generator, so that voices may appear and disappear for some period of time.**

**If no score directive is used, all voices that appear in the [tune body](https://abcnotation.com/wiki/abc:standard:v2.1#tune_body_definition "abc:standard:v2.1 ↵") are printed on separate staves.**

**See [Canzonetta.abc](https://abcnotation.com/wiki/abc:standard:v2.1#canzonettaabc "abc:standard:v2.1 ↵") for an extensive example.**
...
**_VOLATILE:_ See the [section 11 disclaimer](https://abcnotation.com/wiki/abc:standard:v2.1#disclaimer "abc:standard:v2.1 ↵").**
...
**Some abc players can automatically generate an accompaniment based on the [chord symbols](https://abcnotation.com/wiki/abc:standard:v2.1#chord_symbols "abc:standard:v2.1 ↵") specified in the melody line. To suggest a GM instrument for playing this accompaniment, use the following directive:**

**%%MIDI chordprog 20 % Church organ**

### **11.3 Accidental directives**

**_VOLATILE:_ This section is under active discussion. See also the [section 11 disclaimer](https://abcnotation.com/wiki/abc:standard:v2.1#disclaimer "abc:standard:v2.1 ↵").**
...
**_VOLATILE:_ Font directives are due to be considered in abc 2.3 - see the [section 11 disclaimer](https://abcnotation.com/wiki/abc:standard:v2.1#disclaimer "abc:standard:v2.1 ↵").**
...
**The specifiers `$1`, `$2`, `$3` and `$4` can be used to change the font within a [text string](https://abcnotation.com/wiki/abc:standard:v2.1#text_string_definition "abc:standard:v2.1 ↵"). The font to be used can be specified with the `%%setfont-n` directives. `$0` resets the font to its default value. `$$` gives an actual dollar sign.**
...
**_VOLATILE:_ Text directives are due to be considered in abc 2.3 - see the [section 11 disclaimer](https://abcnotation.com/wiki/abc:standard:v2.1#disclaimer "abc:standard:v2.1 ↵").**

**The following directives can be used for inserting [typeset text](https://abcnotation.com/wiki/abc:standard:v2.1#typeset_text_definition "abc:standard:v2.1 ↵") within an [abc file](https://abcnotation.com/wiki/abc:standard:v2.1#abc_file_definition "abc:standard:v2.1 ↵").**
...
-   **`%%text` prints the following text, treated as a [text string](https://abcnotation.com/wiki/abc:standard:v2.1#text_string_definition "abc:standard:v2.1 ↵").**
    
-   **`%%center` prints the following text, treated as a [text string](https://abcnotation.com/wiki/abc:standard:v2.1#text_string_definition "abc:standard:v2.1 ↵") and centred.**
    
-   **`%%begintext` and `%%endtext` mark a section of lines, each of which start with `%%`, followed by some text. It is an alternative to several `%%text` lines. [_Important note:_ some [extensions](https://abcnotation.com/wiki/abc:standard:v2.1#abc_extensions "abc:standard:v2.1 ↵") offered by abc software programs relax the rule that each line between `%%begintext` and `%%endtext` must start with `%%`. Whilst this should not cause problems for [typeset text](https://abcnotation.com/wiki/abc:standard:v2.1#typeset_text_definition "abc:standard:v2.1 ↵") between tunes, [typeset text](https://abcnotation.com/wiki/abc:standard:v2.1#typeset_text_definition "abc:standard:v2.1 ↵") within a [tune header](https://abcnotation.com/wiki/abc:standard:v2.1#tune_header_definition "abc:standard:v2.1 ↵") or [tune body](https://abcnotation.com/wiki/abc:standard:v2.1#tune_body_definition "abc:standard:v2.1 ↵") should respect this rule and, in particular, must not introduce blank lines.]**
    

**See [further information about directives](https://abcnotation.com/wiki/abc:standard:v2.1#further_information_about_directives "abc:standard:v2.1 ↵") for more details and to find out about additional parameters for these directives.**

**_Recommendation for users:_ If you are using text directives for tune-specific information, consider instead using one of the [background information fields](https://abcnotation.com/wiki/abc:standard:v2.1#bdfsbackground_information "abc:standard:v2.1 ↵")together with a `%%writefields` directive (see [information directives](https://abcnotation.com/wiki/abc:standard:v2.1#information_directives "abc:standard:v2.1 ↵")) so that the information can correctly identified by databasing software.**

#### **11.4.6 Information directives**

**_VOLATILE:_ The `%%writefields` directive and its formatting options are likely to be enhanced when markup is considered in abc 2.3. See also the [section 11 disclaimer](https://abcnotation.com/wiki/abc:standard:v2.1#disclaimer "abc:standard:v2.1 ↵").**

**%%writefields <list of field identifiers> [<logical>]**

**The `%%writefields` directive allows users to choose which string-type [information fields](https://abcnotation.com/wiki/abc:standard:v2.1#information_field_definition "abc:standard:v2.1 ↵") appear in the printed score (see the [information fields](https://abcnotation.com/wiki/abc:standard:v2.1#information_fields "abc:standard:v2.1 ↵") table for a list of string-type fields). It is followed by a list of field identifiers and, optionally, the logical value `true` or `false`. If the logical value is missing it is taken as `true`.**

**The `%%writefields` directive also applies to certain instruction fields - namely `X:reference number`, `P:parts` and `Q:tempo`.**

**The default is "`%%writefields TCOPQwW`" meaning that the title (T), composer (C), origin (O), parts (P), tempo (Q), aligned words (w) and other words (W) are printed out by default (see [typesetting information fields](https://abcnotation.com/wiki/abc:standard:v2.1#typesetting_information_fields "abc:standard:v2.1 ↵") for how these should be typeset). Each subseqent `%%writefields` directive combines with this list, rather than overriding it.**
...
**_Comment:_ The `%%writefields` directive can be used in place of a number of directives introduced in abc 2.0:**
...
**See [further information about directives](https://abcnotation.com/wiki/abc:standard:v2.1#further_information_about_directives "abc:standard:v2.1 ↵") for more details of the 2.0 alternatives.**
...
**_Comment:_ Dialects not available under strict interpretation are those where one symbol is used for two different purposes - for example, a `!` symbol used to denote both line-breaks and decorations; fortunately, of the 160,000 tunes currently available in the [abcnotation.com tune search](https://abcnotation.com/search "https://abcnotation.com/search") only around 60 (0.04%) employ this usage.**
...
**By default, a (forced) [score line-break](https://abcnotation.com/wiki/abc:standard:v2.1#score_line-break_definition "abc:standard:v2.1 ↵") is typeset by using a [code line-break](https://abcnotation.com/wiki/abc:standard:v2.1#code_line-break_definition "abc:standard:v2.1 ↵") - see [typesetting line-breaks](https://abcnotation.com/wiki/abc:standard:v2.1#typesetting_line-breaks "abc:standard:v2.1 ↵").**

**In the past the `!` symbol has instead been used to indicate [score line-breaks](https://abcnotation.com/wiki/abc:standard:v2.1#score_line-break_definition "abc:standard:v2.1 ↵") - this symbol is now used to denote decorations.**

**_Comment:_ The `!` symbol was introduced by abc2win, a very popular program in its time, although now moribund. Of the 160,000 tunes currently available in the [abcnotation.com tune search](https://abcnotation.com/search "https://abcnotation.com/search"), only around 1,600 (10%) use the ! symbol to denote line-breaks.**

**Although the use of the `!` symbol for line-breaking is now [deprecated](https://abcnotation.com/wiki/abc:standard:v2.1#outdated_syntax "abc:standard:v2.1 ↵") (see [outdated line-breaking](https://abcnotation.com/wiki/abc:standard:v2.1#outdated_line-breaking "abc:standard:v2.1 ↵")), users who wish to continue using the `!` symbol for line-breaking merely need to include the "`I:linebreak !`" directive, either in the [file header](https://abcnotation.com/wiki/abc:standard:v2.1#file_header_definition "abc:standard:v2.1 ↵") or individually tune by tune - see [typesetting line-breaks](https://abcnotation.com/wiki/abc:standard:v2.1#typesetting_line-breaks "abc:standard:v2.1 ↵").**
...
**Finally a new line-breaking symbol, `$`, has been introduced as an alternative to using [code line-breaks](https://abcnotation.com/wiki/abc:standard:v2.1#code_line-break_definition "abc:standard:v2.1 ↵").**

**_Comment:_ The `$` symbol is effectively a replacement for `!`. It is aimed at those users who want `!` as the decoration delimiter but who prefer to use [code line-breaks](https://abcnotation.com/wiki/abc:standard:v2.1#code_line-break_definition "abc:standard:v2.1 ↵") without generating corresponding [score line-breaks](https://abcnotation.com/wiki/abc:standard:v2.1#score_line-break_definition "abc:standard:v2.1 ↵").**

#### **12.1.2 Decoration dialects**

**Decorations are delimited using the `!` symbol - see [decorations](https://abcnotation.com/wiki/abc:standard:v2.1#decorations "abc:standard:v2.1 ↵").**

**In the past the `+` symbol has instead been used to denote decorations - this symbol is now [deprecated](https://abcnotation.com/wiki/abc:standard:v2.1#outdated_syntax "abc:standard:v2.1 ↵") for decorations.**

**_Comment:_ Decorations were first introduced in draft standard 1.7.6 (which was never formally adopted) with the `!` symbol. In abc 2.0 (adopted briefly whilst discussions about abc 2.1 were taking place) this was changed to the `+`symbol. Neither are in widespread use, but the `!` symbol is much more common - of the 160,000 tunes currently available in the [abcnotation.com tune search](https://abcnotation.com/search "https://abcnotation.com/search"), only around 100 (0.07%) use the `+` symbol to delimit decorations, whereas around 1,350 (0.85%) use the `!` symbol.**

**Users who wish to continue using the `+` symbol for decorations merely need to include the "`I:decoration +`" directive, either in the [file header](https://abcnotation.com/wiki/abc:standard:v2.1#file_header_definition "abc:standard:v2.1 ↵") or individually tune by tune - see [decorations](https://abcnotation.com/wiki/abc:standard:v2.1#decorations "abc:standard:v2.1 ↵"). All `+…+` decorations will then be treated as if they were the corresponding `!…!` decoration and any `!…!` decorations will generate an error message.**
...
**_Recommendation for users:_ Given the very small uptake of the `+` symbol for decorations, "`I:decoration +`" directive is not recommended. However, it is retained for users who wish to use the `!` symbol for line-breaking in legacy [abc files](https://abcnotation.com/wiki/abc:standard:v2.1#abc_file_definition "abc:standard:v2.1 ↵").**

**For completeness the "`I:decoration !`", the default setting, is also available to allow individual tunes to use `!…!` decorations in a file where "`I:decoration +`" is set in the [file header](https://abcnotation.com/wiki/abc:standard:v2.1#file_header_definition "abc:standard:v2.1 ↵").**

#### **12.1.3 Chord dialects**

**Chords are delimited using `[]` symbols - see [chords and unisons](https://abcnotation.com/wiki/abc:standard:v2.1#chords_and_unisons "abc:standard:v2.1 ↵").**

**In the past the `+` symbol has instead been used to delimit chords - this symbol is no longer in use for chords.**

**_Comment:_ In early versions of the abc standard (1.2 to 1.5), chords were delimited with `+` symbols. However, this made it hard to see where one chord ended and another began and the chord delimiters were changed to `[]` in 1.6 (November 1996). Of the 160,000 tunes currently available in the [abcnotation.com tune search](https://abcnotation.com/search "https://abcnotation.com/search"), only around 420 (0.25%) use the `+` symbol to delimit chords. Given the small uptake and the successful introduction of the `[]` symbols, there is no `I:` directive available which allows the use of `+`symbols and this usage is now [obsolete](https://abcnotation.com/wiki/abc:standard:v2.1#outdated_syntax "abc:standard:v2.1 ↵").**

### **12.2 Loose interpretation**

**_Comment:_ There are around 160,000 tunes currently available in the [abcnotation.com tune search](https://abcnotation.com/search "https://abcnotation.com/search") - loose interpretation of the abc standard maintains backwards compatibility without any changes required for this huge and valuable resource.**

**Any [abc file](https://abcnotation.com/wiki/abc:standard:v2.1#abc_file_definition "abc:standard:v2.1 ↵") without a version number, or with a version number of 2.0 or less (see [abc file identification](https://abcnotation.com/wiki/abc:standard:v2.1#abc_file_identification "abc:standard:v2.1 ↵") and [version field](https://abcnotation.com/wiki/abc:standard:v2.1#version_field "abc:standard:v2.1 ↵")), should be interpreted loosely. Developers should do their best to provide programs that understand legacy [abc files](https://abcnotation.com/wiki/abc:standard:v2.1#abc_file_definition "abc:standard:v2.1 ↵"), but users should be aware that loose interpretations may different from one abc program to another.**

**_Recommendation for users:_ Try to avoid loose interpretation if possible; loose interpretation means that if you pass abc notated tunes on to friends, or post them on the web, they may not appear as you hoped.**

**_Recommendation 1 for developers:_ Do your best! The most difficult tunes to deal with are those which use the same symbol for two different purposes - in particular the ! symbol for both decorations and line-breaking. Here is an algorithm for helping to deal with `!decoration!` syntax and `!` line-breaks in the same tune:**
...
**_Recommendation 2 for developers:_ Although moving towards strict interpretations should make life easier for everybody (developers and users alike), you should allow users to switch easily between strict and loose interpretation, perhaps via a command line switch or a GUI check-box. For example, a user who imports an old [abc file](https://abcnotation.com/wiki/abc:standard:v2.1#abc_file_definition "abc:standard:v2.1 ↵") may wish to see how it would be interpreted strictly, perhaps to establish how many strict errors need fixing.**

### **12.3 Strict interpretation**

**Any [abc file](https://abcnotation.com/wiki/abc:standard:v2.1#abc_file_definition "abc:standard:v2.1 ↵") with an abc version number greater than or equal to 2.1 (see [abc file identification](https://abcnotation.com/wiki/abc:standard:v2.1#abc_file_identification "abc:standard:v2.1 ↵") and [version field](https://abcnotation.com/wiki/abc:standard:v2.1#version_field "abc:standard:v2.1 ↵")) should be interpreted strictly, with errors indicated to the user as such.**
...
**For more details see [text strings](https://abcnotation.com/wiki/abc:standard:v2.1#text_strings "abc:standard:v2.1 ↵") and for further information see, for example:**
...
-   **[http://en.wikipedia.org/wiki/List_of_XML_and_HTML_character_entity_references](http://en.wikipedia.org/wiki/List_of_XML_and_HTML_character_entity_references "http://en.wikipedia.org/wiki/List_of_XML_and_HTML_character_entity_references")**
    
-   **[http://en.wikipedia.org/wiki/List_of_Unicode_characters](http://en.wikipedia.org/wiki/List_of_Unicode_characters "http://en.wikipedia.org/wiki/List_of_Unicode_characters")**
...
-   **[Section 1.1.1 Terminology / definitions](https://abcnotation.com/wiki/abc:standard:v2.1#terminology_definitions "abc:standard:v2.1 ↵"): The definition of _VOLATILE_ has been clarified; it is used to indicate "sections which are under active discussion and/or are likely to change in some future version of the standard" rather than "sections which are under active discussion or likely to change at some point in the future" (8th Jan 2012).**
    
-   **[Section 6.1.1 Typesetting line-breaks](https://abcnotation.com/wiki/abc:standard:v2.1#typesetting_line-breaks "abc:standard:v2.1 ↵"): Typo: `setbarno` corrected to `setbarnb` in two places (8th Jan 2012).**
    
-   **[Section 8.2 Text strings](https://abcnotation.com/wiki/abc:standard:v2.1#text_strings "abc:standard:v2.1 ↵"): Typos for accent mnemonics (cedilla and ring): "`\,C \,c`" and "`\oA \oa`" corrected to "`\cC \cc`" and "`\AA \aa`", respectively, as per [Section 14.1 Supported accents & ligatures](https://abcnotation.com/wiki/abc:standard:v2.1#supported_accents_ligatures "abc:standard:v2.1 ↵") (8th Jan 2012).  
    _TODO:_ `\,` and `\o` are non-standard accent mnemonics introduced in abc 2.0; however, it is probably sensible to support them in addition to the standard, but less memorable, `\c` and `\a`.**
    
-   **[Section 11.4.6 Information directives](https://abcnotation.com/wiki/abc:standard:v2.1#information_directives "abc:standard:v2.1 ↵"): The statement "Note that the `%%writefields` directive does not apply to instruction-type fields, such as parts (P) and tempo (Q)" has now been removed, as it conflicted with other information in the same section (8th Jan 2012).**
    
-   **[Section 4.18 Chord symbols](https://abcnotation.com/wiki/abc:standard:v2.1#chord_symbols "abc:standard:v2.1 ↵"): Typo: `sustained` corrected to `suspended` (26th May 2012).**
    
-   **[Section 4.6 Clefs and transposition](https://abcnotation.com/wiki/abc:standard:v2.1#clefs_and_transposition "abc:standard:v2.1 ↵"): following discussion, this section has been corrected to clarify that the `middle` setting does not affect the playback (since there is no consistent way that it can do so). The [Zocharti Loch example](https://abcnotation.com/wiki/abc:standard:v2.1#multiple_voices "abc:standard:v2.1 ↵") has been corrected and its accompanying midi file (which has persisted unchanged from abc draft 2.0, and which seemed to indicate `middle` might, in some circumstances, affect the playback) has been removed (20th February 2013).**
...
  [Back to top](https://abcnotation.com/wiki/abc:standard:v2.1#dokuwiki__top)** 
...
      **[![Recent changes RSS feed](https://abcnotation.com/wiki/lib/tpl/default/images/button-rss.png)](https://abcnotation.com/wiki/feed.php "Recent changes RSS feed") [![](https://abcnotation.com/wiki/lib/images/license/button/cc-by-nc-sa.png)](http://creativecommons.org/licenses/by-nc-sa/3.0/ "CC Attribution-Noncommercial-Share Alike 3.0 Unported") [![Donate](https://abcnotation.com/wiki/lib/tpl/default/images/button-donate.gif)](http://www.dokuwiki.org/donate "Donate") [![Powered by PHP](https://abcnotation.com/wiki/lib/tpl/default/images/button-php.gif)](http://www.php.net/ "Powered by PHP") [![Valid XHTML 1.0](https://abcnotation.com/wiki/lib/tpl/default/images/button-xhtml.png)](http://validator.w3.org/check/referer "Valid XHTML 1.0") [![Valid CSS](https://abcnotation.com/wiki/lib/tpl/default/images/button-css.png)](http://jigsaw.w3.org/css-validator/check/referer?profile=css3 "Valid CSS") [![Driven by DokuWiki](https://abcnotation.com/wiki/lib/tpl/default/images/button-dw.png)](http://dokuwiki.org/ "Driven by DokuWiki")**

**![](https://abcnotation.com/wiki/lib/exe/indexer.php?id=abc%3Astandard%3Av2.1&1677149425)**
